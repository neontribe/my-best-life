...
export const QuizProvider = ({ children }: QuizProviderProps): JSX.Element => {
  ...
  const [aboutYou, setAboutYou] = useState<IAboutYou>(defaultValue.aboutYou)
  ...
  useEffect(() => {
    ...
    setAboutYou(getFromLocalStorage('quiz/aboutYou', defaultValue.aboutYou))
  }, [])
  ...
  }, [whatsOnMind, howAreFeeling, interests, aboutYou])
